                    ...
                    courseTime.click(function () {
                        ...
                        for (var i = 0; i < datas.length; i++) {
                            if (datas[i].CardId == cardId) {
                                ...
                                $('.m2eBox').eq(0).html('<img style="width: 98%;height: 600px;padding-left: 10px; padding-top: 2px;" src="' + (card.ClassContent || '/assets/image/class-intro.png') + '">');
            ...
            webAbc.ajax({
                ...
                success: function (rel) {
                    ...
                    if (layer) {
                        ...
                        webAbc.showMessage(type, message);
                    }
                    //}
