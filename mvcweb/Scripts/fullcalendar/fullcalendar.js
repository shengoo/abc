    ...
    $.fn.fullCalendar = function (options) {
        ...
        this.each(function (i, _element) { // loop each DOM element involved
            ...
            if (typeof options === 'string') {
                ...
                calendar.render();
                window.calendarSchedule = calendar;
            }
        });
    ...
    */
    ...
    DayGrid.mixin({
        ...
        fgSegHtml: function (seg, disableResizing) {
            ...
            return '<a data_id=' + event.id + ' onclick="openCourseLesson(this)" onmouseover="overschedule(this,event)" onmouseout="outschedule(this)" style="cursor:pointer" class="' + classes.join(' ') + '"' +
    ...
    TimeGrid.mixin({
        ...
        fgSegHtml: function (seg, disableResizing) {
            ...
            return '<a class="' + classes.join(' ') + '"' +
                ' data_id=' + event.id + ' onclick="openCourseLesson(this)" style="cursor:pointer"' +
                (skinCss ?
                    ' style="' + skinCss + '"' :
                    ''
                    ) +
    ...
    function Calendar_constructor(element, overrides) {
        ...
        //    var calendar = window.calendarSchedule,
        //        events = calendar.clientEvents();

        //    var delEvents = events.filter(function (event) {
        //        for (var i = 0; i < window.courseLesson.length; i++) {
        //            if (window.courseLesson[i].CplId == event.id)
        //                return false;
        //        }
        //        return true;
        //    });
        //    calendar.removeEvents(delEvents);
        //    calendar.removeEventSource(delEvents);
        //    renderView();
        //    window.refresh = false;
        //}
        //setInterval(function () {
        //    if (window.refresh === true) refreshEventSource();
        //}, 1000)
        ...
        function prev() {
            ...
            renderView();
            month--;
            this.addEventSource(window.GetScheduleData(month));
        }
