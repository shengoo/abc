...
$(document).ready(function () {
    ...
    $('button').bind('click', function () {
        ...
        if (method == 'hidemasktip') {
            $('.masktip').addClass('hidden');
...
$(function () {
    ...
    //登陆
    $('.header .get .exit').click(function () {
        showLogin();
    });
    //注册
    $('.header .get .enroll').click(function () {
        showRegister();
    });

    //底部注册按钮
    $('.fixed-register .buttons').click(function () {
        window.top.showRegister();
    });

    $('.page-type.adult').click(function () {
        $('.choose-page').hide();
    });
    $('.choose-page-link').click(function (e) {
        e.preventDefault();
