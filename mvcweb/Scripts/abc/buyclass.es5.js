...
$(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function success(res) {
                    ...
                    for (var i = 0; i < rel.length; i++) {
                        if (data.cika.length == 0) str += '<div data="1" name="type" class="course flt" ><b></b>次卡</div>';
                    ...
                    $('.courseinfo').append($('<div class="clearfix"><ul class="course_ul clearfix">' + '<li class="clearfix"><div class="hidden coursetype"><div class="course_t flt">课程类型：</div>' + str + '</div></li>' + (time == '' ? '' : '<li name="1" class="clearfix"><div class="coursetype">' + '<div class="course_t flt label-left" style="height:' + (rel.length > 4 ? '70px' : '30px') + '">课程套餐</div>' + time + '</div></li>') + (type == '' ? '' : '<li name="2" class="clearfix hidden" ><div class="coursetype"><div class="course_t flt label-left">课程套餐</div>' + type + '</div></li>') + '</ul></div>'));
    ...
    $.ajax({
        ...
        success: function success(res) {
            ...
            for (var i = 0; i < categorys.length; i++) str += '<li data="' + categorys[i].Code + '">' + categorys[i].CategoryName + '</li>';
    ...
    $('.number_input').on('change', function () {
        ...
        if (/^[1-9]\d{0,2}$/.test(el.value)) el.style.borderColor = '';else el.style.borderColor = '#f00';
    });
});
