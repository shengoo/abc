...
namespace abc.Model.SQLServerDAL
{
	...
	/// 数据访问类:AskNotifyPlan
	/// </summary>
	public partial class AskNotifyPlan:IAskNotifyPlan
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("AskId", "AskNotifyPlan"); 
		}

		/// <summary>
		/// 是否存在该记录
		/// </summary>
		public bool Exists(int AskId,int NotifyId)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from AskNotifyPlan");
			strSql.Append(" where AskId=SQL2012AskId and NotifyId=SQL2012NotifyId ");
		...
		public bool Delete(int NotifyId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from AskNotifyPlan ");
			strSql.Append(" where NotifyId=SQL2012NotifyId");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012NotifyId", SqlDbType.Int,4)
			};
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(int AskId,int NotifyId)
		{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select NotifyId,AskId,Content,OrderBy,CreateTime ");
			strSql.Append(" FROM AskNotifyPlan ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" NotifyId,AskId,Content,OrderBy,CreateTime ");
			strSql.Append(" FROM AskNotifyPlan ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from AskNotifyPlan T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "AskNotifyPlan";
			parameters[1].Value = "NotifyId";
