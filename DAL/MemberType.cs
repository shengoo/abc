...
namespace abc.Model.SQLServerDAL
{
	...
	/// 数据访问类:MemberType
	/// </summary>
	public partial class MemberType:IMemberType
	{
		public MemberType()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("TypeId", "MemberType"); 
		}
		...
		public bool Exists(int TypeId)
		{
			...
			strSql.Append(" where TypeId=SQL2012TypeId");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(abc.Model.Model.MemberType model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into MemberType(");
			strSql.Append("TypeName,Enabled)");
			strSql.Append(" values (");
			strSql.Append("SQL2012TypeName,SQL2012Enabled)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012TypeName", SqlDbType.VarChar,255),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(abc.Model.Model.MemberType model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public abc.Model.Model.MemberType GetModel(int TypeId)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 TypeId,TypeName,Enabled from MemberType ");
			strSql.Append(" where TypeId=SQL2012TypeId");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012TypeId", SqlDbType.Int,4)
			};
			...
			abc.Model.Model.MemberType model=new abc.Model.Model.MemberType();
		...
		/// 得到一个对象实体
		/// </summary>
		public abc.Model.Model.MemberType DataRowToModel(DataRow row)
		{
			abc.Model.Model.MemberType model=new abc.Model.Model.MemberType();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select TypeId,TypeName,Enabled ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" TypeId,TypeName,Enabled ");
			strSql.Append(" FROM MemberType ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
