...
namespace DAL
{
    ...
    /// </summary>
    public class CourseCategoryDao : BaseModel<CourseCategory>
    {
        #region  BasicMethod
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("CategoryId", "CourseCategory");
        }
        ...
        public bool Exists(int CategoryId)
        {
            ...
            strSql.Append(" where CategoryId=SQL2012CategoryId");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(CourseCategory model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into CourseCategory(");
            strSql.Append("CategoryName,Enabled,CreateTime)");
            strSql.Append(" values (");
            strSql.Append("SQL2012CategoryName,SQL2012Enabled,SQL2012CreateTime)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
					new SqlParameter("SQL2012CategoryName", SqlDbType.VarChar,255),
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(CourseCategory model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update CourseCategory set ");
            strSql.Append("CategoryName=SQL2012CategoryName,");
        ...
        /// 得到一个对象实体
        /// </summary>
        public CourseCategory GetModel(int CategoryId)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 CategoryId,CategoryName,Enabled,CreateTime from CourseCategory ");
            strSql.Append(" where CategoryId=SQL2012CategoryId");
            SqlParameter[] parameters = {
					new SqlParameter("SQL2012CategoryId", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public CourseCategory DataRowToModel(DataRow row)
        {
            CourseCategory model = new CourseCategory();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select CategoryId,CategoryName,Enabled,CreateTime ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" CategoryId,CategoryName,Enabled,CreateTime ");
            strSql.Append(" FROM CourseCategory ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
