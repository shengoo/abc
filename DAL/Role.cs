...
namespace abc.Model.SQLServerDAL
{
	...
	public partial class Role:IRole
	{
		...
		public bool Exists(string RoleName,int RoleId)
		{
			...
			strSql.Append(" where RoleName=SQL2012RoleName and RoleId=SQL2012RoleId ");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012RoleName", SqlDbType.VarChar,255),
		...
		/// 增加一条数据
		/// </summary>
		public int Add(abc.Model.Model.Role model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Role(");
			strSql.Append("RoleName)");
			strSql.Append(" values (");
			strSql.Append("SQL2012RoleName)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(abc.Model.Model.Role model)
		{
			StringBuilder strSql=new StringBuilder();
...
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！ 
			...
			strSql.Append(" where RoleId=SQL2012RoleId");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012RoleId", SqlDbType.Int,4),
					new SqlParameter("SQL2012RoleName", SqlDbType.VarChar,255)};
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(string RoleName,int RoleId)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public abc.Model.Model.Role GetModel(int RoleId)
		{
			...
			abc.Model.Model.Role model=new abc.Model.Model.Role();
		...
		/// 得到一个对象实体
		/// </summary>
		public abc.Model.Model.Role DataRowToModel(DataRow row)
		{
			abc.Model.Model.Role model=new abc.Model.Model.Role();
			if (row != null)
			{
