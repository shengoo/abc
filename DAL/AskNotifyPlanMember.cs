...
{
	/// <summary>
	/// 数据访问类:AskNotifyPlanMember
	/// </summary>
	public partial class AskNotifyPlanMember:IAskNotifyPlanMember
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("AskId", "AskNotifyPlanMember"); 
		}

		/// <summary>
		/// 是否存在该记录
		/// </summary>
		public bool Exists(string NotifyId,int AskId,int ReceiverId,int NotifyMId)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from AskNotifyPlanMember");
			strSql.Append(" where NotifyId=SQL2012NotifyId and AskId=SQL2012AskId and ReceiverId=SQL2012ReceiverId and NotifyMId=SQL2012NotifyMId ");
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(int NotifyMId)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from AskNotifyPlanMember ");
			strSql.Append(" where NotifyMId=SQL2012NotifyMId");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012NotifyMId", SqlDbType.Int,4)
			};
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(string NotifyId,int AskId,int ReceiverId,int NotifyMId)
		{
		...
		/// 批量删除数据
		/// </summary>
		public bool DeleteList(string NotifyMIdlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from AskNotifyPlanMember ");
			strSql.Append(" where NotifyMId in ("+NotifyMIdlist + ")  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select NotifyMId,NotifyId,AskId,ReceiverId,Content,IsSend,SendDate,OrderBy,CreateTime ");
			strSql.Append(" FROM AskNotifyPlanMember ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" NotifyMId,NotifyId,AskId,ReceiverId,Content,IsSend,SendDate,OrderBy,CreateTime ");
			strSql.Append(" FROM AskNotifyPlanMember ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.NotifyMId desc");
			}
			strSql.Append(")AS Row, T.*  from AskNotifyPlanMember T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "AskNotifyPlanMember";
			parameters[1].Value = "NotifyMId";
