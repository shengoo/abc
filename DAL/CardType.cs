...
namespace abc.Model.SQLServerDAL
{
	...
	public partial class CardType:ICardType
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("TypeId", "CardType"); 
		}

		/// <summary>
		/// 是否存在该记录
		/// </summary>
		public bool Exists(string TypeName,int TypeId)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from CardType");
			strSql.Append(" where TypeName=SQL2012TypeName and TypeId=SQL2012TypeId ");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(abc.Model.Model.CardType model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into CardType(");
			strSql.Append("TypeName)");
			strSql.Append(" values (");
			strSql.Append("SQL2012TypeName)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(abc.Model.Model.CardType model)
		{
			StringBuilder strSql=new StringBuilder();
...
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！ 
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(string TypeName,int TypeId)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public abc.Model.Model.CardType GetModel(int TypeId)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 TypeId,TypeName from CardType ");
			strSql.Append(" where TypeId=SQL2012TypeId");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012TypeId", SqlDbType.Int,4)
			};
			...
			abc.Model.Model.CardType model=new abc.Model.Model.CardType();
		...
		/// 得到一个对象实体
		/// </summary>
		public abc.Model.Model.CardType DataRowToModel(DataRow row)
		{
			abc.Model.Model.CardType model=new abc.Model.Model.CardType();
			if (row != null)
			{
