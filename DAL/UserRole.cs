...
namespace abc.Model.SQLServerDAL
{
	...
	public partial class UserRole:IUserRole
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "UserRole"); 
		}
		...
		/// 增加一条数据
		/// </summary>
		public int Add(abc.Model.Model.UserRole model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into UserRole(");
			strSql.Append("UserId,RoleId)");
			strSql.Append(" values (");
			strSql.Append("SQL2012UserId,SQL2012RoleId)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(abc.Model.Model.UserRole model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public abc.Model.Model.UserRole GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,UserId,RoleId from UserRole ");
			strSql.Append(" where ID=SQL2012ID");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012ID", SqlDbType.Int,4)
			};
			...
			abc.Model.Model.UserRole model=new abc.Model.Model.UserRole();
		...
		/// 得到一个对象实体
		/// </summary>
		public abc.Model.Model.UserRole DataRowToModel(DataRow row)
		{
			abc.Model.Model.UserRole model=new abc.Model.Model.UserRole();
			if (row != null)
			{
